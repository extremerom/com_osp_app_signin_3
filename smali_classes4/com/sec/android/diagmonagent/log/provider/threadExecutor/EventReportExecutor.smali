...
.method private addParcelFileDescriptor(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    const-string p0, "Zipped file size : "
...
.method private eventReportViaCP(Landroid/content/Context;Lcom/sec/android/diagmonagent/log/provider/DiagMonConfig;Lcom/sec/android/diagmonagent/log/provider/EventBuilder;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {p1, p4, v0, v3, p2}, Landroid/content/ContentResolver;->call(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method private makeEventObjAsBundle(Lcom/sec/android/diagmonagent/log/provider/DiagMonConfig;Lcom/sec/android/diagmonagent/log/provider/EventBuilder;)Landroid/os/Bundle;
    ...
    iget-object p0, p0, Lcom/sec/android/diagmonagent/log/provider/threadExecutor/EventReportExecutor;->context:Landroid/content/Context;

    invoke-static {p0}, Lcom/sec/android/diagmonagent/log/provider/utils/DiagMonUtil;->isForeground(Landroid/content/Context;)Ljava/lang/String;
...
.method private sendLogPath()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/sec/android/diagmonagent/log/provider/threadExecutor/EventReportExecutor;->mConfig:Lcom/sec/android/diagmonagent/log/provider/DiagMonConfig;
