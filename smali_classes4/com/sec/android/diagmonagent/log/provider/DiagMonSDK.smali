...
.method public static customEventReport(Landroid/content/Context;Lcom/sec/android/diagmonagent/log/provider/EventBuilder;)Z
    ...
    const-string v0, "Request CustomEventReport"
    ...
    invoke-static {p0, v0}, Lcom/sec/android/diagmonagent/common/logger/AppLog;->initLogger(Landroid/content/Context;Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK$CONFIGURATION_TYPE;->DEFAULT:Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK$CONFIGURATION_TYPE;
...
.method public static enableUncaughtExceptionLogging(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p0, v0, v2}, Lcom/sec/android/diagmonagent/log/provider/DiagMonLogger;-><init>(Landroid/content/Context;Ljava/lang/Thread$UncaughtExceptionHandler;Lcom/sec/android/diagmonagent/log/provider/DiagMonConfig;)V
...
.method public static declared-synchronized startOperation(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-class v1, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK;
    ...
    sput-object v2, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK;->ops:Ljava/util/ArrayList;
    ...
    sget-object v3, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK;->ops:Ljava/util/ArrayList;

    invoke-static {v2, v3, p0}, Lcom/sec/android/diagmonagent/dma/aperf/utils/aPerfValidation;->checkStartOpPreCondition(Landroid/content/Context;Ljava/util/ArrayList;Ljava/lang/String;)Z
...
.method public static declared-synchronized startSubOperation(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "Start subOperation: "
    ...
    invoke-static {v2, p0, p1}, Lcom/sec/android/diagmonagent/dma/aperf/utils/aPerfValidation;->checkStartSubOpPreCondition(Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1, v2}, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK;->generateNewSubOperation(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sec/android/diagmonagent/dma/aperf/SubOperation;

    move-result-object p1

    sget-object v2, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK;->ops:Ljava/util/ArrayList;

    invoke-static {v2, p0}, Lcom/sec/android/diagmonagent/dma/aperf/utils/aPerfUtil;->getTheOperation(Ljava/util/ArrayList;Ljava/lang/String;)Lcom/sec/android/diagmonagent/dma/aperf/Operation;
...
.method public static declared-synchronized stopOperation(Ljava/lang/String;)Z
    ...
    :try_start_0
    new-array v7, v1, [Lcom/sec/android/diagmonagent/dma/aperf/Tag;
    ...
    invoke-static/range {v2 .. v7}, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK;->stopOperation(Ljava/lang/String;JJ[Lcom/sec/android/diagmonagent/dma/aperf/Tag;)Z
...
.method public static varargs declared-synchronized stopOperation(Ljava/lang/String;JJ[Lcom/sec/android/diagmonagent/dma/aperf/Tag;)Z
    ...
    const-string v0, "Stop operation: "

    const-string v1, "Try stop operation: "

    const-class v2, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK;
    ...
    const-string v1, "It doesn\'t have any operations, please check it again."
    ...
    invoke-virtual {p1, p2, p3, v3, v4}, Lcom/sec/android/diagmonagent/dma/aperf/SubOperation;->setSubOpCountSize(JJ)V
...
.method public static declared-synchronized stopSubOperation(Ljava/lang/String;JJ)Z
    ...
    const-string v0, "Stop subOperation: "

    const-string v1, "Try stop subOperation: "
    ...
    invoke-static {v4, p0}, Lcom/sec/android/diagmonagent/dma/aperf/utils/aPerfUtil;->getTheSubOperation(Ljava/util/ArrayList;Ljava/lang/String;)Lcom/sec/android/diagmonagent/dma/aperf/SubOperation;
...
.method public isEnableUncaughtExceptionLogging()Z
    ...
    sget-boolean p0, Lcom/sec/android/diagmonagent/log/provider/DiagMonSDK;->isEnableUncaughtExceptionLogging:Z
