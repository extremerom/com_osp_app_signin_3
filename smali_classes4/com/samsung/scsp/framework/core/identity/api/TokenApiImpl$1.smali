...
# instance fields
.field final synthetic this$0:Lcom/samsung/scsp/framework/core/identity/api/TokenApiImpl;
...
.method public onStream(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;Ljava/io/ByteArrayOutputStream;)V
    ...
    new-instance p3, Lcom/samsung/scsp/framework/core/identity/api/b;

    const/4 v0, 0x0

    invoke-direct {p3, p1, v0}, Lcom/samsung/scsp/framework/core/identity/api/b;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {p2, v2, p3}, La;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/samsung/scsp/framework/core/identity/api/TokenApiImpl$1;->this$0:Lcom/samsung/scsp/framework/core/identity/api/TokenApiImpl;

    invoke-static {p0}, Lcom/samsung/scsp/framework/core/identity/api/TokenApiImpl;->access$000(Lcom/samsung/scsp/framework/core/identity/api/TokenApiImpl;)Lcom/samsung/scsp/error/Logger;

    move-result-object p0

    const-string p1, "Success to issue token with account"
    ...
    const-string p1, "Success to issue token without account"
