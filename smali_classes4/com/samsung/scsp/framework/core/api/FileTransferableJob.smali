...
.method public getFileUrl(Lcom/samsung/scsp/framework/core/SContext;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/samsung/scsp/framework/core/api/FileTransferableJob;->apiPath:Ljava/lang/String;

    invoke-static {v0, p1, p0}, Lcom/samsung/scsp/framework/core/ers/ScspErs;->getBaseUrlOfPath(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public onTransferred(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;JJLjava/nio/ByteBuffer;)V
    ...
    check-cast p0, Lcom/samsung/scsp/framework/core/api/FileTransferableJob$FileVo;

    if-eqz p0, :cond_0

    iget-object p2, p0, Lcom/samsung/scsp/framework/core/api/FileTransferableJob$FileVo;->channel:Ljava/nio/channels/FileChannel;

    if-eqz p2, :cond_0

    invoke-virtual {p7}, Ljava/nio/ByteBuffer;->flip()Ljava/nio/Buffer;

    iget-wide p2, p0, Lcom/samsung/scsp/framework/core/api/FileTransferableJob$FileVo;->transferred:J

    iget-object p4, p0, Lcom/samsung/scsp/framework/core/api/FileTransferableJob$FileVo;->channel:Ljava/nio/channels/FileChannel;

    invoke-virtual {p4, p7}, Ljava/nio/channels/FileChannel;->write(Ljava/nio/ByteBuffer;)I
    ...
    iput-wide p2, p0, Lcom/samsung/scsp/framework/core/api/FileTransferableJob$FileVo;->transferred:J
    ...
    const-string p3, "IOException occurred while storing the data received from the server in a file."
...
.method public setFilePath(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/io/FileOutputStream;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p2}, Lcom/samsung/scsp/framework/core/api/FileTransferableJob$FileVo;-><init>(Lcom/samsung/scsp/framework/core/api/FileTransferableJob;Ljava/io/FileOutputStream;)V
