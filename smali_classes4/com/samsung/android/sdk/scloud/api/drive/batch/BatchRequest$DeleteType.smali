...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;

    const-string v2, "DELETE_FROM_TRASH"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;->DELETE_FROM_TRASH:Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;

    new-instance v2, Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;

    const-string v3, "DELETE_PERMANENTLY"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;->DELETE_PERMANENTLY:Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;

    filled-new-array {v0, v1, v2}, [Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;

    move-result-object v0

    sput-object v0, Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;->$VALUES:[Lcom/samsung/android/sdk/scloud/api/drive/batch/BatchRequest$DeleteType;
