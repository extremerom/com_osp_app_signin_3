.class public Lcom/samsung/android/sdk/scloud/decorator/certificate/api/job/CertificateRefreshUserAesKeyJobImpl;
.super Lcom/samsung/android/sdk/scloud/api/ResponsiveJob;
.source "SourceFile"


# static fields
.field private static final TAG:Ljava/lang/String; = "CertificateRefreshUserAesKeyJobImpl"
...
.method public handleStream(Lcom/samsung/android/sdk/scloud/network/HttpRequest;Ljava/util/Map;Ljava/io/InputStream;)V
    ...
    sget-object v0, Lcom/samsung/android/sdk/scloud/decorator/certificate/api/job/CertificateRefreshUserAesKeyJobImpl;->TAG:Ljava/lang/String;
    ...
    invoke-static {p2, p3, v0}, Lt9;->v(Lcom/samsung/android/sdk/scloud/api/Response;Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_0
    invoke-virtual {p2}, Lcom/samsung/android/sdk/scloud/api/Response;->toJson()Lcom/google/gson/JsonObject;

    move-result-object p2

    const-string p3, "userAesKeyList"

    invoke-virtual {p2, p3}, Lcom/google/gson/JsonObject;->getAsJsonArray(Ljava/lang/String;)Lcom/google/gson/JsonArray;
    ...
    new-instance v0, Lcom/samsung/android/sdk/scloud/decorator/certificate/api/job/CertificateRefreshUserAesKeyJobImpl$1;

    invoke-direct {v0, p0}, Lcom/samsung/android/sdk/scloud/decorator/certificate/api/job/CertificateRefreshUserAesKeyJobImpl$1;-><init>(Lcom/samsung/android/sdk/scloud/decorator/certificate/api/job/CertificateRefreshUserAesKeyJobImpl;)V

    invoke-virtual {v0}, Lcom/google/gson/reflect/TypeToken;->getType()Ljava/lang/reflect/Type;

    move-result-object p0

    invoke-virtual {p3, p2, p0}, Lcom/google/gson/Gson;->fromJson(Lcom/google/gson/JsonElement;Ljava/lang/reflect/Type;)Ljava/lang/Object;
