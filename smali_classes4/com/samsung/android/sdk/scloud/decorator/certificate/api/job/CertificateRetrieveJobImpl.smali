.class public Lcom/samsung/android/sdk/scloud/decorator/certificate/api/job/CertificateRetrieveJobImpl;
.super Lcom/samsung/android/sdk/scloud/api/ResponsiveJob;
.source "SourceFile"


# static fields
.field private static final TAG:Ljava/lang/String; = "CertificateRetrieveJobImpl"
...
.method public handleStream(Lcom/samsung/android/sdk/scloud/network/HttpRequest;Ljava/util/Map;Ljava/io/InputStream;)V
    ...
    sget-object v0, Lcom/samsung/android/sdk/scloud/decorator/certificate/api/job/CertificateRetrieveJobImpl;->TAG:Ljava/lang/String;
    ...
    invoke-static {p0, p2, v0}, Lt9;->v(Lcom/samsung/android/sdk/scloud/api/Response;Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_0
    const-class p2, Lcom/samsung/android/sdk/scloud/decorator/certificate/CertificateInfo;

    invoke-virtual {p0, p2}, Lcom/samsung/android/sdk/scloud/api/Response;->create(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/samsung/android/sdk/scloud/decorator/certificate/CertificateInfo;
