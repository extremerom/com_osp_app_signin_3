...
.method public run()V
    ...
    :cond_7
    iget-object p0, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimation;->mDrawable:Landroid/graphics/drawable/Drawable;
...
.method public stop()V
    ...
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue;->mAnimatingList:Ljava/util/ArrayList;
...
.method public updateAnimatorData(Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;Z)Z
    ...
    iget-object p0, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->updateParameter:Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;

    iput-boolean p2, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isLastFrame:Z

    const/4 p2, 0x0

    iput-boolean p2, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedStrokeColor:Z

    iput-boolean p2, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedFillColor:Z

    iput-boolean p2, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedTranslate:Z

    iput-boolean p2, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedRotate:Z

    iput-boolean p2, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedScale:Z

    iget-object v0, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->object:Lcom/samsung/android/spr/drawable/document/shape/SprObjectBase;

    iget v0, v0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectBase;->alpha:F

    iput v0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->alpha:F

    iget-object p0, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->animatorSet:Landroid/animation/AnimatorSet;
    ...
    iget-object v1, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->updateParameter:Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;

    invoke-virtual {v0, v1}, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase;->update(Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;)Z
    ...
    :cond_1
    iget-object p0, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->matrix:Lcom/samsung/android/spr/drawable/document/attribute/SprAttributeMatrix;

    invoke-virtual {p0}, Lcom/samsung/android/spr/drawable/document/attribute/SprAttributeMatrix;->reset()V

    iget-object p0, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->updateParameter:Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;

    iget-boolean v0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedScale:Z
    ...
    iget-object v0, v0, Lcom/samsung/android/spr/drawable/document/attribute/SprAttributeMatrix;->matrix:Landroid/graphics/Matrix;

    iget v1, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->scaleX:F

    iget v2, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->scaleY:F

    iget v3, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->scalePivotX:F

    iget p0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->scalePivotY:F
    ...
    iget-boolean v0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedRotate:Z
    ...
    iget v1, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->rotateDegree:F

    iget v2, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->rotatePivotX:F

    iget p0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->rotatePivotY:F

    invoke-virtual {v0, v1, v2, p0}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    :cond_3
    iget-object p0, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->updateParameter:Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;

    iget-boolean v0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedTranslate:Z
    ...
    iget v1, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->translateDx:F

    iget p0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->translateDy:F
    ...
    iget-boolean v0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedFillColor:Z

    if-eqz v0, :cond_5

    iget-object v0, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->fillPaint:Lcom/samsung/android/spr/drawable/document/attribute/SprAttributeFill;

    iget v1, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->fillColor:I

    iput v1, v0, Lcom/samsung/android/spr/drawable/document/attribute/SprAttributeColor;->color:I

    :cond_5
    iget-boolean v0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->isUpdatedStrokeColor:Z

    if-eqz v0, :cond_6

    iget-object v0, p1, Lcom/samsung/android/spr/drawable/animation/SprDrawableAnimationValue$AnimatorData;->strokePaint:Lcom/samsung/android/spr/drawable/document/attribute/SprAttributeStroke;

    iget v1, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->strokeColor:I
    ...
    iget p0, p0, Lcom/samsung/android/spr/drawable/document/animator/SprAnimatorBase$UpdateParameter;->alpha:F

    iput p0, p1, Lcom/samsung/android/spr/drawable/document/shape/SprObjectBase;->alpha:F
