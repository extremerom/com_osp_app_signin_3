...
.method private validate(Ljava/math/BigInteger;Z)Ljava/math/BigInteger;
    ...
    :cond_0
    :goto_0
    sget-object p0, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->validated:Lorg/bouncycastle/util/BigIntegers$Cache;

    invoke-virtual {p0, p1}, Lorg/bouncycastle/util/BigIntegers$Cache;->add(Ljava/math/BigInteger;)V
    ...
    const-string p0, "org.bouncycastle.rsa.allow_unsafe_mod"
    ...
    :cond_2
    const-string p0, "org.bouncycastle.rsa.max_size"

    const/16 p2, 0x3c00

    invoke-static {p0, p2}, Lorg/bouncycastle/util/Properties;->asInteger(Ljava/lang/String;I)I
    ...
    sget-object p0, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->SMALL_PRIMES_PRODUCT:Ljava/math/BigInteger;

    invoke-virtual {p1, p0}, Ljava/math/BigInteger;->gcd(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object p0

    sget-object p2, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->ONE:Ljava/math/BigInteger;
    ...
    const-string p2, "org.bouncycastle.rsa.max_mr_tests"

    invoke-static {p0}, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->getMRIterations(I)I

    move-result p0

    invoke-static {p2, p0}, Lorg/bouncycastle/util/Properties;->asInteger(Ljava/lang/String;I)I
    ...
    invoke-static {p1, p2, p0}, Lorg/bouncycastle/math/Primes;->enhancedMRProbablePrimeTest(Ljava/math/BigInteger;Ljava/security/SecureRandom;I)Lorg/bouncycastle/math/Primes$MROutput;
    ...
    const-string p1, "modulus value out of range"
