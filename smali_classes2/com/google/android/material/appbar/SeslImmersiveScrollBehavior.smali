...
.method private canImmersiveScroll()Z
    ...
    invoke-static {}, Ldu;->p()I

    move-result v3

    invoke-static {v0, v3}, Lie;->f(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method private finishWindowInsetsAnimationController()V
    ...
    :cond_3
    invoke-static {v1}, Loo;->A(Landroid/view/WindowInsetsAnimationController;)Landroid/graphics/Insets;

    move-result-object p0

    iget p0, p0, Landroid/graphics/Insets;->bottom:I

    invoke-static {v1}, Loo;->h(Landroid/view/WindowInsetsAnimationController;)Landroid/graphics/Insets;

    move-result-object v0

    iget v0, v0, Landroid/graphics/Insets;->bottom:I

    invoke-static {v1}, Ldu;->d(Landroid/view/WindowInsetsAnimationController;)Landroid/graphics/Insets;
    ...
    invoke-static {v1}, Lie;->r(Landroid/view/WindowInsetsAnimationController;)V
    ...
    invoke-static {v1}, Lie;->D(Landroid/view/WindowInsetsAnimationController;)V
...
.method private forceHideRoundedCorner(I)V
    ...
    :cond_0
    invoke-static {v0}, Loo;->h(Landroid/view/WindowInsetsAnimationController;)Landroid/graphics/Insets;
...
.method private isHideCameraCutout(Landroid/view/WindowInsets;)Z
    ...
    invoke-static {p1, p0}, Lie;->f(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method private isNavigationBarBottomPosition()Z
    ...
    invoke-static {p0, v1}, Lie;->f(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method private isTouchInGestureNavigationArea(FLandroid/view/WindowInsets;)Z
    ...
    invoke-static {}, Ldu;->x()I

    move-result v0

    invoke-static {p2, v0}, Lie;->f(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method private setInsetsAndAlphaToDefault()V
    ...
    invoke-static {v0, v2}, Lie;->f(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {p0, v0}, Lie;->s(Landroid/view/WindowInsetsAnimationController;Landroid/graphics/Insets;)V
...
.method private setWindowInsetsController()V
    ...
    invoke-static {v0}, Loo;->m(Landroid/view/View;)Landroid/view/WindowInsetsController;
...
.method private setupDecorsFitSystemWindowState(Z)V
    ...
    :goto_0
    invoke-static {v0}, Lie;->q(Landroid/view/Window;)V
    ...
    invoke-static {p1, v0}, Lie;->f(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {v0}, Lie;->C(Landroid/view/Window;)V
    ...
    invoke-static {p0, p1}, Loo;->B(Landroid/view/WindowInsetsController;I)V
    :try_end_0
...
.method private startAnimationControlRequest()V
    ...
    invoke-static {v1, v0}, Loo;->B(Landroid/view/WindowInsetsController;I)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "startAnimationControlRequest: mWindowInsetsController.hide failed!"
    ...
    invoke-static {v1}, Lie;->u(Landroid/view/WindowInsetsController;)V
    ...
    invoke-static {v1, v0, v2, p0}, Lie;->v(Landroid/view/WindowInsetsController;ILandroid/os/CancellationSignal;Landroid/view/WindowInsetsAnimationControlListener;)V
...
.method private updateSystemBarsHeight()V
    ...
    invoke-static {v0, v1}, Lie;->f(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method public cancelWindowInsetsAnimationController()V
    ...
    invoke-static {v0, v1}, Ldu;->o(Landroid/view/WindowInsets;I)Z
    ...
    invoke-static {v1, v2}, Ldu;->o(Landroid/view/WindowInsets;I)Z
    ...
    invoke-static {v0, v1}, Loo;->t(Landroid/view/WindowInsetsAnimationController;Z)V
...
.method public forceRestoreWindowInset(Z)V
    ...
    invoke-static {p0, p1}, Loo;->u(Landroid/view/WindowInsetsController;I)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public initImmViews(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;)V
    ...
    invoke-static {v1, v2}, Loo;->r(Landroid/view/View;Landroid/view/WindowInsetsAnimation$Callback;)V
...
.method public layoutChild(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;I)V
    ...
    invoke-static {v0, p3}, Lie;->w(Landroid/view/WindowInsetsController;Landroid/view/WindowInsetsController$OnControllableInsetsChangedListener;)V
...
.method public notifyOnDetachedFromWindow()V
    ...
    invoke-static {v1, v0}, Ldu;->m(Landroid/view/WindowInsetsController;Landroid/view/WindowInsetsController$OnControllableInsetsChangedListener;)V
...
.method public release()V
    ...
    invoke-static {v0}, Lie;->p(Landroid/view/View;)V
...
.method public setWindowInsetsAnimationCallback(Lcom/google/android/material/appbar/AppBarLayout;Landroid/view/WindowInsetsAnimation$Callback;)V
    ...
    invoke-static {p2, v0}, Loo;->r(Landroid/view/View;Landroid/view/WindowInsetsAnimation$Callback;)V
    ...
    invoke-static {p1, p0}, Loo;->r(Landroid/view/View;Landroid/view/WindowInsetsAnimation$Callback;)V
