.class public final Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;",
        "Lcom/samsung/android/samsungaccount/authentication/server/request/token/JwsTokenSingleRequest;",
        "Lcom/samsung/android/samsungaccount/authentication/server/vo/passkey/PasskeyAuthenticationOptionsResponseVo;",
        "context",
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;->userName:Ljava/lang/String;
...
.method public synthetic constructor <init>(Landroid/content/Context;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method public static final synthetic access$handleSuccessResponse(Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;Landroid/content/Context;Lcom/samsung/android/samsungaccount/utils/server/lib/volley/SuccessResponse;)Lcom/samsung/android/samsungaccount/utils/server/lib/volley/SingleResponse;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;->handleSuccessResponse(Landroid/content/Context;Lcom/samsung/android/samsungaccount/utils/server/lib/volley/SuccessResponse;)Lcom/samsung/android/samsungaccount/utils/server/lib/volley/SingleResponse;
...
.method private static final baseObservable$lambda$0(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;Lio/reactivex/SingleEmitter;)V
    .locals 12
    ...
    iget-object v1, p2, Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;->userName:Ljava/lang/String;

    new-instance v11, Lcom/samsung/android/samsungaccount/utils/server/lib/volley/SingleResponseListener;

    new-instance v7, Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest$baseObservable$1$1;

    invoke-direct {v7, p2}, Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest$baseObservable$1$1;-><init>(Ljava/lang/Object;)V

    const/16 v9, 0x28

    const/4 v10, 0x0

    const-string v4, "CreatePasskeyAuthenticationOptionsRequest"
...
.method private static final baseObservable$lambda$1(Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;)V
    .locals 2
    ...
    const-string v0, "CreatePasskeyAuthenticationOptionsRequest"
...
.method public static synthetic e(Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;)V
    .locals 0

    invoke-static {p0}, Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;->baseObservable$lambda$1(Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;)V

    return-void
.end method

.method public static synthetic f(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;Lio/reactivex/SingleEmitter;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;->baseObservable$lambda$0(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/samsungaccount/authentication/server/request/passkey/CreatePasskeyAuthenticationOptionsRequest;Lio/reactivex/SingleEmitter;)V
...
.method private final handleSuccessResponse(Landroid/content/Context;Lcom/samsung/android/samsungaccount/utils/server/lib/volley/SuccessResponse;)Lcom/samsung/android/samsungaccount/utils/server/lib/volley/SingleResponse;
    ...
    const-class p2, Lcom/samsung/android/samsungaccount/authentication/server/vo/passkey/PasskeyAuthenticationOptionsResponseVo;

    invoke-virtual {p0, p1, p2}, Lcom/google/gson/Gson;->fromJson(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/samsung/android/samsungaccount/authentication/server/vo/passkey/PasskeyAuthenticationOptionsResponseVo;
