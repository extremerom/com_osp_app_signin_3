...
.method public static toFlowProcessor(Lorg/reactivestreams/Processor;)Ljava/util/concurrent/Flow$Processor;
    ...
    :cond_0
    invoke-static {p0}, Lx;->A(Lorg/reactivestreams/Processor;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Lx;->i(Lorg/reactivestreams/Processor;)Ljava/util/concurrent/Flow$Processor;
...
.method public static toFlowPublisher(Lorg/reactivestreams/Publisher;)Ljava/util/concurrent/Flow$Publisher;
    ...
    :cond_0
    invoke-static {p0}, Lx;->B(Lorg/reactivestreams/Publisher;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Lx;->j(Lorg/reactivestreams/Publisher;)Ljava/util/concurrent/Flow$Publisher;
...
.method public static toFlowSubscriber(Lorg/reactivestreams/Subscriber;)Ljava/util/concurrent/Flow$Subscriber;
    ...
    :cond_0
    invoke-static {p0}, Lx;->C(Lorg/reactivestreams/Subscriber;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Lx;->k(Lorg/reactivestreams/Subscriber;)Ljava/util/concurrent/Flow$Subscriber;
