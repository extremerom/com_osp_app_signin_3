...
.method public constructor <init>(III[SLorg/bouncycastle/crypto/Xof;Lorg/bouncycastle/pqc/crypto/frodo/FrodoMatrixGenerator;)V
    ...
    invoke-static {p2, v0, v3, p3}, Lot;->b(IIII)I
    ...
    invoke-static {p1, p2, v2, v1}, Lrf;->a(IIII)I
...
.method public kem_dec([B[B[B)V
    ...
    invoke-static {v3, v11, v8, v2}, Lot;->b(IIII)I
    ...
    invoke-static {v2, v3, v8, v0}, Lot;->b(IIII)I
    ...
    invoke-direct {v7, v12, v8, v8}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->unpack([BII)[S
    ...
    invoke-direct {v7, v11, v0, v8, v8}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_sub([S[SII)[S
    ...
    invoke-interface {v1, v3, v9, v2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    iget-object v1, v7, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    iget v2, v7, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_mu_bytes:I

    invoke-interface {v1, v6, v9, v2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    iget-object v1, v7, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    iget v2, v7, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_seedSE_bytes:I

    iget v3, v7, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_k_bytes:I

    add-int/2addr v2, v3

    invoke-interface {v1, v0, v9, v2}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
    ...
    invoke-interface {v3, v0, v9, v4}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    iget-object v0, v7, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    invoke-interface {v0, v2, v9, v1}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
    ...
    invoke-direct {v7, v4, v9, v8, v0}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->sample_matrix([SIII)[S
    ...
    invoke-direct {v7, v4, v1, v8, v0}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->sample_matrix([SIII)[S
    ...
    invoke-virtual {v0, v14}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoMatrixGenerator;->genMatrix([B)[S
    ...
    invoke-direct {v7, v0, v9, v8, v1}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_add([S[SII)[S
    ...
    invoke-direct {v7, v1, v0, v8, v8}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->sample_matrix([SIII)[S

    move-result-object v6

    iget v0, v7, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->n:I

    invoke-direct {v7, v15, v0, v8}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->unpack([BII)[S
    ...
    invoke-direct {v7, v1, v11, v9, v0}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->ctverify([S[S[S[S)S

    move-result v0

    invoke-direct {v7, v14, v13, v0}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->ctselect([B[BS)[B
...
.method public kem_keypair([B[BLjava/security/SecureRandom;)V
    ...
    iget p0, p0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_pkh_bytes:I

    sub-int/2addr p1, p0

    invoke-static {v4, v2, p2, p1, p0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
