.class public final Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainChildAuthCodeMode;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainChildAuthCodeMode$WhenMappings;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainChildAuthCodeMode;",
...
.method private final setStrategies()V
    ...
    const-string v0, "FamilyMainChildAuthCodeMode"
...
.method public getNeedLocalDataSource()Z
    ...
    iget-boolean p0, p0, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainChildAuthCodeMode;->needLocalDataSource:Z
...
.method public handlePreconditionResult(Landroidx/appcompat/app/AppCompatActivity;)V
    ...
    :cond_0
    sget-object v1, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainChildAuthCodeMode$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    :cond_2
    const-string v0, "kids_watch_oobe_on_parent"

    invoke-virtual {p0, p1, v0}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainModeController;->startAddAccount(Landroidx/appcompat/app/AppCompatActivity;Ljava/lang/String;)Lkotlin/Unit;
...
.method public initMode(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    const-string p1, "FamilyMainChildAuthCodeMode"

    const-string v0, "initMode"

    invoke-static {p1, v0}, Lcom/samsung/android/samsungaccount/utils/log/SALog;->i(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainChildAuthCodeMode;->setStrategies()V
    ...
    :goto_0
    const-string v0, "device_security_code"
    ...
    :goto_1
    const-string v0, "account_selection_token"
    ...
    :goto_2
    const-string v0, "parent_account_name"
    ...
    :goto_3
    const-string v0, "child_account_name"
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/samsungaccount/authentication/data/child/authcode/ChildAuthCodeRepository;->initChildAuthCodeRequestData(Lcom/samsung/android/samsungaccount/authentication/data/child/authcode/ChildAuthCodeRequestData;)V
...
.method public onPostGetMemberInfoResultSuccess()V
    ...
    new-instance v0, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupMainOrganizerState$ChildAuthCodeNeeded;
    ...
    invoke-interface {p0}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainModeAction;->getMemberList()Landroidx/lifecycle/LiveData;
    ...
    invoke-interface {p0, v2}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainModeAction;->hasChildMember(Ljava/util/List;)Z

    move-result v2

    invoke-direct {v0, v1, v2}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupMainOrganizerState$ChildAuthCodeNeeded;-><init>(ZZ)V
    ...
    :cond_0
    sget-object v0, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupMainMemberEvent$CanNotSetUpWatchForChild;->INSTANCE:Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupMainMemberEvent$CanNotSetUpWatchForChild;
...
.method public setNeedLocalDataSource(Z)V
    ...
    iput-boolean p1, p0, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyMainChildAuthCodeMode;->needLocalDataSource:Z
