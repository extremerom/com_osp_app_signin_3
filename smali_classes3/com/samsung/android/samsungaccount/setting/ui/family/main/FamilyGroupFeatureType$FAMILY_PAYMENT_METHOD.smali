.class final Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupFeatureType$FAMILY_PAYMENT_METHOD;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupFeatureType$FAMILY_PAYMENT_METHOD$WhenMappings;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "isFamilyPaymentMethodAvailable",
        "",
        "context",
...
.annotation build Lkotlin/jvm/internal/SourceDebugExtension;
    value = {
        "SMAP\nFamilyGroupFeatureType.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FamilyGroupFeatureType.kt\ncom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupFeatureType$FAMILY_PAYMENT_METHOD\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,109:1\n1#2:110\n*E\n"
    }
.end annotation
...
.method private final isFamilyPaymentMethodAvailable(Landroid/content/Context;)Z
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/BillingPaymentHelper;->isFamilyPaymentMethodSupported(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/BillingPaymentHelper;->checkSamsungBilling(Landroid/content/Context;)Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-static {p1}, Lcom/samsung/android/samsungaccount/authentication/ui/util/FamilyGroupUtilKt;->isSignUpCountryCodeChina(Landroid/content/Context;)Z
    ...
    :goto_0
    const-string p1, "isFamilyPaymentMethodAvailable: "
...
.method public launchItem(Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupMainOrganizerFragment;)V
    ...
    const-string v0, "FAMILY_PAYMENT_METHOD, launchItem()"

    invoke-static {p0, v0}, Lcom/samsung/android/samsungaccount/utils/log/SALog;->i(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupMainOrganizerFragment;->launchFamilyPaymentMethod()V
...
.method public setItemAvailability(Landroid/content/Context;Lcom/samsung/android/samsungaccount/setting/ui/family/FamilyGroupMemberType;)V
    ...
    sget-object v1, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupFeatureType$FAMILY_PAYMENT_METHOD$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    const-string p0, "FAMILY_PAYMENT_METHOD, unsupported member!"
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/samsung/android/samsungaccount/setting/ui/family/main/FamilyGroupFeatureType$FAMILY_PAYMENT_METHOD;->isFamilyPaymentMethodAvailable(Landroid/content/Context;)Z
    ...
    const-string p1, "FAMILY_PAYMENT_METHOD, setItemAvailability: "
